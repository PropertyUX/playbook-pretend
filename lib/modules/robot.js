...
class Robot extends _es.Robot {
  ...
  /**
     ...
     */
  emit(event) {var _HubotRobot$prototype;for (var _len = arguments.length, args = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {args[_key - 1] = arguments[_key];}
    this.eventLog.push([event, args]);
    (_HubotRobot$prototype = _es.Robot.prototype.emit).call.apply(_HubotRobot$prototype, [this, event].concat(args));
  }
...
Robot;module.exports = exports['default'];
